...
/**
 * CL-0358 — International Family Tax Estimate Planner
 * Category: Personal Finance → Tax & Insurance
 * Type: Planner | Priority: P2 Growth | Complexity: Professional
 *
 * PURPOSE: Plan and schedule with priorities and deadlines
 *
...
export default function Tool_CL_0358({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>International Family Tax Estimate Planner</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Plan and schedule with priorities and deadlines</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            International Family Tax Estimate Planner
          </div>
          <div style={{ fontSize: 12, color: 'var(--txt2)', maxWidth: 340, lineHeight: 1.6 }}>
            Plan and schedule with priorities and deadlines
          </div>
