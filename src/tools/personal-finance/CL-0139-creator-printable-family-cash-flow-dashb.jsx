...
/**
 * CL-0139 — Creator Printable Family Cash Flow Dashboard
 * Category: Personal Finance → Family & Household
 * Type: Dashboard | Priority: P3 Expansion | Complexity: Professional
 *
 * PURPOSE: Plan monthly income vs expenses and cumulative flow
 *
...
const COLOR  = '#7f77dd'
const ICON   = 'ti-arrows-exchange'

export default function Tool_CL_0139({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>Creator Printable Family Cash Flow Dashboard</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Plan monthly income vs expenses and cumulative flow</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            Creator Printable Family Cash Flow Dashboard
          </div>
          <div style={{ fontSize: 12, color: 'var(--txt2)', maxWidth: 340, lineHeight: 1.6 }}>
            Plan monthly income vs expenses and cumulative flow
          </div>
