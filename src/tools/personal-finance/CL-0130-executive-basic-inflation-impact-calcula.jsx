...
/**
 * CL-0130 — Executive Basic Inflation Impact Calculator
 * Category: Personal Finance → Financial Planning
 * Type: Calculator | Priority: P3 Expansion | Complexity: Simple
 *
 * PURPOSE: See how inflation erodes purchasing power
 *
...
const COLOR  = '#ef9f27'
const ICON   = 'ti-chart-line'

export default function Tool_CL_0130({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>Executive Basic Inflation Impact Calculator</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>See how inflation erodes purchasing power</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            Executive Basic Inflation Impact Calculator
          </div>
