...
/**
 * CL-0155 — International Annual Emergency Fund Tracker
 * Category: Personal Finance → Savings
 * Type: Tracker | Priority: P1 Launch | Complexity: Professional
 *
 * PURPOSE: Build and track emergency fund toward X months expenses
 *
...
const COLOR  = '#2ecc87'
const ICON   = 'ti-piggy-bank'

export default function Tool_CL_0155({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>International Annual Emergency Fund Tracker</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Build and track emergency fund toward X months expenses</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            International Annual Emergency Fund Tracker
          </div>
          <div style={{ fontSize: 12, color: 'var(--txt2)', maxWidth: 340, lineHeight: 1.6 }}>
            Build and track emergency fund toward X months expenses
          </div>
