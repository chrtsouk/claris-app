...
/**
 * CL-0244 — Small Business Annual Loan Repayment Calculator
 * Category: Personal Finance → Debt & Credit
 * Type: Calculator | Priority: P4 Long-Term | Complexity: Professional
 *
 * PURPOSE: Calculate payments and full amortisation schedule
 *
...
export default function Tool_CL_0244({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>Small Business Annual Loan Repayment Calculator</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Calculate payments and full amortisation schedule</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            Small Business Annual Loan Repayment Calculator
          </div>
          <div style={{ fontSize: 12, color: 'var(--txt2)', maxWidth: 340, lineHeight: 1.6 }}>
            Calculate payments and full amortisation schedule
          </div>
