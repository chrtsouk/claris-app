...
/**
 * CL-0242 — Retirement Offline Deduction Checklist
 * Category: Personal Finance → Tax & Insurance
 * Type: Checklist | Priority: P0 MVP | Complexity: Professional
 *
 * PURPOSE: Track tax-deductible expenses by category
 *
...
export default function Tool_CL_0242({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>Retirement Offline Deduction Checklist</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Track tax-deductible expenses by category</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            Retirement Offline Deduction Checklist
          </div>
