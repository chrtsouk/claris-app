...
/**
 * CL-0150 — Multi-Currency Template Household Expense Tracker
 * Category: Personal Finance → Expense Tracking
 * Type: Tracker | Priority: P3 Expansion | Complexity: Standard
 *
 * PURPOSE: Log and categorise daily expenses with totals
 *
...
const COLOR  = '#378add'
const ICON   = 'ti-receipt'

export default function Tool_CL_0150({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>Multi-Currency Template Household Expense Tracker</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Log and categorise daily expenses with totals</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            Multi-Currency Template Household Expense Tracker
          </div>
          <div style={{ fontSize: 12, color: 'var(--txt2)', maxWidth: 340, lineHeight: 1.6 }}>
            Log and categorise daily expenses with totals
          </div>
