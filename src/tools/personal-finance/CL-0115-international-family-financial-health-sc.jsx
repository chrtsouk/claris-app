...
/**
 * CL-0115 — International Family Financial Health Score
 * Category: Personal Finance → Financial Planning
 * Type: Tracker | Priority: P1 Launch | Complexity: Advanced
 *
 * PURPOSE: Score financial wellbeing across 8 key areas
 *
...
const COLOR  = '#ef9f27'
const ICON   = 'ti-heartbeat'

export default function Tool_CL_0115({ tool }) {
  // ── STATE ────────────────────────────────────────────────────
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bdr)', background: 'var(--bg2)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, color: 'var(--txt)' }}>International Family Financial Health Score</div>
          <div style={{ fontSize: 11, color: 'var(--txt2)' }}>Score financial wellbeing across 8 key areas</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--txt)', marginBottom: 8 }}>
            International Family Financial Health Score
          </div>
          <div style={{ fontSize: 12, color: 'var(--txt2)', maxWidth: 340, lineHeight: 1.6 }}>
            Score financial wellbeing across 8 key areas
          </div>
